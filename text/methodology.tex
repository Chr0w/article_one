...
can be used just as well as geometric lidar, radar or sonar points, both 2D and 3D. The third is that changes that \textit{could} be sensed but aren't, should not affect the index. 
